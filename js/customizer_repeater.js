...
jQuery(document).ready(function () {
    ...
    avril_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        ...
        {
        if(jQuery('#exist_avril_Slider').val()>=50)
        {
        ...
        {
        if(jQuery('#exist_avril_Testimonial').val()>=3)
        {
        ...
        // return false;   
         ...
         if(jQuery('#exist_avril_Testimonial').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_avril_Testimonial').val())+1;
         jQuery('#exist_avril_Testimonial').val(new_service_add_val);  
        }
        }
    ...
    avril_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_avril_Testimonial').val(parseInt(jQuery('#exist_avril_Testimonial').val())-1); 
                }
